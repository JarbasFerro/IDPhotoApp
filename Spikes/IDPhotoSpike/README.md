...
- Moments ([experience plan](../../docs/15-experience-plan.md), stage B): the portrait lands into its frame after analysis, a readiness ring around the shutter closes and counts down, the sheet preview re-flows with a spring, and Share opens with a quiet tick; all gated on Reduce Motion.
- Four-step flow ([experience plan](../../docs/15-experience-plan.md), stage A): Home, Photo Check (plain-language headline and rows, hold to compare), Adjust sheet (direct manipulation, four controls, details on demand), Your Sheet, Share; Spanish and English; developer details behind a long press on the version line.
