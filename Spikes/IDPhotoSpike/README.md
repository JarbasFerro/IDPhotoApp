...
- Capture aids ([spike 05 addendum](../../docs/spikes/05-guided-camera.md)): phone level from Core Motion with a horizon line, face pitch and distance from a throttled live Vision pass, lighting direction and backlight from the luma plane, face-metered exposure, a four-segment readiness row, and auto capture with a countdown.
