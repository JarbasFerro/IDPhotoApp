...
- Hint priority: presence, size, distance, position, head roll (phone or head wording), yaw, head pitch (phone or height wording), backlight, darkness, one-sided light, hold still, ready.
